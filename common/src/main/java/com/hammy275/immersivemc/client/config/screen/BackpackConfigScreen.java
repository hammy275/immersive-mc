...
import com.hammy275.immersivemc.client.immersive.ImmersiveBackpackOld;
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        guiRenderState.addPicturesInPictureState(new CustomGuiRendererState(
                ...
                (poseStack, bufferSource) -> {
                    ...
                    ImmersiveBackpackOld.getBackpackModel().renderToBuffer(poseStack,
                            bufferSource.getBuffer(RenderTypes.entityCutout(ImmersiveBackpackOld.getBackpackTexture())),
                            15728880, OverlayTexture.NO_OVERLAY, ImmersiveBackpackOld.getBackpackColor());
                }
        ));
    }
