...
public class BeaconInfo extends AbstractBlockBasedImmersiveInfo {
    ...
    public int getEffectId() {
        return switch (this.effectSelected) {
            case 0 -> Registry.MOB_EFFECT.getId(MobEffects.MOVEMENT_SPEED);
            case 1 -> Registry.MOB_EFFECT.getId(MobEffects.DIG_SPEED);
            case 2 -> Registry.MOB_EFFECT.getId(MobEffects.DAMAGE_RESISTANCE);
            case 3 -> Registry.MOB_EFFECT.getId(MobEffects.JUMP);
            case 4 -> Registry.MOB_EFFECT.getId(MobEffects.DAMAGE_BOOST);
            default -> -1;
        };
    }
}
