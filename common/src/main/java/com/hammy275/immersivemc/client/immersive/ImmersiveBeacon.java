...
public class ImmersiveBeacon extends AbstractImmersive<BeaconInfo, BeaconStorage> {
    ...
    private static final ResourceLocation confirmLocation = new ResourceLocation(ImmersiveMC.MOD_ID, "immersive/beacon/confirm.png");
    private static final ResourceLocation addLocation = new ResourceLocation(ImmersiveMC.MOD_ID, "immersive/beacon/add.png");
            ...
            if (useGrabBeacon()) {
                ...
                if (!heldImages.isEmpty()) {
                    if (info.lastLevel < 4) {
                        ...
                        if (secondaryId != -2) {
                            secondaryId = info.regenSelected ? BuiltInRegistries.MOB_EFFECT.getId(MobEffects.REGENERATION) : -1;
                        }
                    }
