...
public class ClientBookData extends CommonBookData {
    ...
    private static final ResourceLocation writtenBookTexture = ResourceLocation.fromNamespaceAndPath(ImmersiveMC.MOD_ID, "immersive/nahnotfox_written_book.png");
