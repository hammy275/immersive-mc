...
/**
 * Representation of a built Immersive made using an {@link BlockBasedImmersiveBuilder}. This acts as an {@link BlockBasedImmersive}, but
 * can also be used to make new {@link BlockBasedImmersiveBuilder}s that start as copies of this built Immersive.
