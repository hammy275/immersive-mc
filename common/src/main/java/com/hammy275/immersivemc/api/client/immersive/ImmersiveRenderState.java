 ...
 * {@link Immersive#extractRenderState} for more info.
 */
public interface ImmersiveRenderState {

    /**
     * Gets the list of all hitboxes for interaction, this interface's counterpart to
     * {@link ImmersiveInfo#getAllHitboxes()}. Like its counterpart, the list can contain null elements.
     * <p>
     ...
     * {@link ImmersiveInfo#getTicksExisted()}.
     ...
     * {@link ImmersiveInfo#getSlotHovered(int)}, but this function gets the slot and returns whether that slot
     * is hovered, whereas {@link ImmersiveInfo#getSlotHovered(int)} gets the hand index and returns the hovered
     * slot.
