...
public class Swap {
    ...
    public static boolean doEnchanting(int slot, BlockPos pos, ServerPlayer player, InteractionHand hand) {
        ...
        ETableWorldStorage storage = (ETableWorldStorage) WorldStoragesImpl.getOrCreateS(pos, player.getLevel());
    ...
    public static Optional<CraftingRecipe> getRecipe(ServerPlayer player, ItemStack[] stacksIn) {
    ...
    public static ItemStack[] handleDoCraft(ServerPlayer player, ItemStack[] stacksIn,
        ...
        RecipeBookMenu<CraftingContainer> menu = isBackpack ? new InventoryMenu(player.getInventory(), false, player) : new CraftingMenu(-1, player.getInventory());
