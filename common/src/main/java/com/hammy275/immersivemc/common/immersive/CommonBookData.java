...
public class CommonBookData implements NetworkStorage {
    ...
    public Vec3 getLeftRightVector(PosRot bookPosRot, boolean left) {
        ...
        leftF.transform(Vector3f.ZP.rotationDegrees(bookPosRot.getRoll()));
        leftF.transform(Vector3f.XN.rotationDegrees(bookPosRot.getPitch()));
        leftF.transform(Vector3f.YN.rotationDegrees(bookPosRot.getYaw()));
