...
public class ImmersiveMCConfig {
    ...
    protected static void setupConfig(ForgeConfigSpec.Builder builder) {
        ...
        useChiseledBookshelfImmersion = builder
                .comment("Whether immersives for chiseled bookshelves should be allowed.")
                .define("chiseled_bookshelf_immersion", true);
        ...
        useIronFurnacesFurnaceImmersion = builder
                .comment("Whether immersives for furnaces from Iron Furnaces should be allowed.")
                .define("iron_furnaces_furnace_immersion", true);
    ...
    public static void resetToDefault() {
        ...
        useIronFurnacesFurnaceImmersion.set(true);
