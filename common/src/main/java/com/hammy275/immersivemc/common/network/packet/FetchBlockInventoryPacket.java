...
public class FetchBlockInventoryPacket<S extends NetworkStorage> {
    ...
    public static <NS extends NetworkStorage> void encode(FetchBlockInventoryPacket<NS> packet, FriendlyByteBuf buffer) {
    ...
    public static <NS extends NetworkStorage> FetchBlockInventoryPacket<NS> decode(FriendlyByteBuf buffer) {
