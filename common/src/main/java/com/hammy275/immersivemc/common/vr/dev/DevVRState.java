...
public class DevVRState {
    ...
    public static void clientTick() {
        ...
        if (player != null) {
            ...
            player.level().addParticle(new DustParticleOptions(0xFFFFFF, 1f),
            ...
            player.level().addParticle(new DustParticleOptions(0x0000FF, 1f),
            ...
            player.level().addParticle(new DustParticleOptions(0xFF0000, 1f),
