...
public class CommonConstants {
    ...
    public static final int distanceToRemoveAttachmentImmersive = 32;
    public static final int distanceSquaredToRemoveImmersive = distanceToRemoveImmersive * distanceToRemoveImmersive;
    public static final int distanceSquaredToRemoveAttachmentImmersive = distanceToRemoveAttachmentImmersive * distanceToRemoveAttachmentImmersive;
