...
public class ApothSalvagingTableHandler extends ItemWorldStorageHandler<ApothSalvagingTableStorage> {
    ...
    public ApothSalvagingTableStorage makeInventoryContents(ServerPlayer tracker, BlockPos pos) {
        return (ApothSalvagingTableStorage) WorldStoragesImpl.getOrCreateS(pos, tracker.level());
    }
    ...
    public void swap(int slot, InteractionHand hand, BlockPos pos, ServerPlayer tracker, ItemSwapAmount amount) {
        ApothSalvagingTableStorage storage = (ApothSalvagingTableStorage) WorldStoragesImpl.getOrCreateS(pos, tracker.level());
