...
public class BeaconDataPacket {
    ...
    public static BeaconDataPacket fromBeacon(BeaconBlockEntity beacon) {
        ...
        int primaryId = Registry.MOB_EFFECT.getId(accessor.immersiveMC$getPrimaryPower());
        ...
        return new BeaconDataPacket(beacon.getBlockPos(),
                powerIndex, Registry.MOB_EFFECT.getId(accessor.immersiveMC$getSecondaryPower()) == regenId);
    }
