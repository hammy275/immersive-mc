...
public class BeaconDataPacket {
    ...
    public static BeaconDataPacket fromBeacon(BeaconBlockEntity beacon) {
        ...
        int primaryId = BuiltInRegistries.MOB_EFFECT.getId(accessor.immersiveMC$getPrimaryPower());
        ...
        return new BeaconDataPacket(beacon.getBlockPos(),
                powerIndex, BuiltInRegistries.MOB_EFFECT.getId(accessor.immersiveMC$getSecondaryPower()) == regenId);
    }
