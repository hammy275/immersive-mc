...
public class AttachmentSwapPacket {
    ...
    public AttachmentSwapPacket(ResourceLocation handlerID, UUID owner, List<Integer> slots, InteractionHand hand, SwapMode mode) {
    ...
    public static void encode(AttachmentSwapPacket packet, FriendlyByteBuf buffer) {
    ...
    public static AttachmentSwapPacket decode(FriendlyByteBuf buffer) {
