...
public class PlatformImpl {
    ...
    public static void sendToServer(FriendlyByteBuf message) {
        ImmersiveMCNeoForge.NETWORK.sendToServer(new BufferPacket(message));
    }
    public static void sendToPlayer(ServerPlayer player, FriendlyByteBuf message) {
        ImmersiveMCNeoForge.NETWORK.send(PacketDistributor.PLAYER.with(() -> player), new BufferPacket(message));
    }
}
